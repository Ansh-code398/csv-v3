          ...
          <div className="wrapper">
            <div className="left-side">
              ...
              <div className="side-wrapper">
                <div className="side-menu">
                  ...
                  <div className="user">
                    <img src="https://pbs.twimg.com/profile_images/2452384114/noplz47r59v1uxvyg8ku.png" alt="" className="user-img" />
                    <div className="username">Bessie Casey</div>
                  </div>
                  <div className="user">
                    <img src="https://images.unsplash.com/photo-1575084713138-342cae5f8d00?ixlib=rb-1.2.1&auto=format&fit=crop&w=958&q=80" alt="" className="user-img" />
            ...
            <div className="main-container">
              <div className="profile">
                <img src="https://cdn.discordapp.com/attachments/917987656632250378/958642944393510952/CS_Voyager_banners.png" alt="" className="profile-cover" />
                ...
                <div className="profile-menu">
                  <div className="profile-avatar">
                    <img className="profile-img" src="https://github.com/Ansh-code398/csvoyager-images/blob/main/brand/logo.png?raw=true" alt="" />
                    <div className="profile-name">CS Voyager</div>
                  </div>
                  <div className="follow-buttons">
                    <input type="email" className="follow my-2" style={{cursor: 'text'}} placeholder="Your Email" ref={followEmail}/>
                    <button className="follow follow-option my-2">Follow</button>
                  </div>
                </div>
              </div>
              ...
              <div className="footer">
                <div className="footer-row">
                  <button className="button language">Language: English(UK)
                  </button>
                  ...
                  <button className="button language">History
                  </button>
                </div>
                <div className="footer-row">
                  <button className="button language">Location: England
                  </button>
                  ...
                  <button className="button language">Help
                  </button>
                </div>
              </div>
              <div className="footer-last">
                <div className="footer-year">2022. CSV</div>
